...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/home/m351534/data/minneapple/annotations/instances_train.json',
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/home/m351534/data/minneapple/annotations/instances_test.json',
        img_prefix='/home/m351534/data/minneapple/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
classes = ('apple', )
n_classes = 1
work_dir = '/home/m351534/tutfrutdet/minneapple/retinanet_effb3_fpn_crop896_minneapple'
auto_resume = False
gpu_ids = [0]
